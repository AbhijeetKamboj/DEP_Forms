...
export default async function StudentAffairsVehicleStickerDashboardPage({
  searchParams,
}: {
  ...
  const pendingForms = await listVehicleStickerFormsForStage(3);
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="mb-2 flex items-start justify-between gap-4">
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold text-slate-900">Student Affairs Dashboard</h1>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-lg text-amber-700">Open queue to review pending Student Affairs requests.</p>
            </div>
            <div className="relative">
              <Link
                href={
                  isQueueOpen
                    ? "/dashboard/vehicle-sticker/student-affairs-hostel-mgmt"
                    : "/dashboard/vehicle-sticker/student-affairs-hostel-mgmt?queue=open"
                }
