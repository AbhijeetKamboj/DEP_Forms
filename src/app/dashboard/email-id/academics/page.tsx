...
export default async function AcademicsForwardingDashboardPage({
  searchParams,
}: {
  ...
  await requireRole(["FORWARDING_AUTHORITY_ACADEMICS", "SYSTEM_ADMIN"]);
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="relative">
              <Link
                href={isQueueOpen ? "/dashboard/email-id/academics" : "/dashboard/email-id/academics?queue=open"}
